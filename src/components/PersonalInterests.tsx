...
export const PersonalInterests = () => {
  return (
    <section id="personal" className="mt-2">
      ...
      <Card className="p-8 bg-card border-border shadow-[var(--shadow-card)]">
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="text-xl font-semibold text-foreground mb-2">Family & Community</h3>
            <p className="text-muted-foreground">
              When I'm not creating or exploring, I value spending time with friends and family who inspire and
              support me. These relationships keep me grounded and motivated to pursue my goals.
            </p>
          </div>
        </div>
      </Card>

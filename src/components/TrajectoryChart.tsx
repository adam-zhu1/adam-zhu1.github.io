...
const WAYPOINTS = [
  { x: 0.16, year: "2023", label: "VR research · Iowa State" },
  { x: 0.4, year: "2024", label: "Forensics research · CSAFE" },
  { x: 0.62, year: "2024", label: "First publication" },
  { x: 0.86, year: "Now", label: "Carnegie Mellon · Stat & ML" },
] as const;
